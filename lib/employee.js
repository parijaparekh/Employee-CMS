...
class Employee {
    ...
    async getAllEmployees(){
        const sql = 'select concat(e.first_name," ", e.last_name) as employee_name, r.title as title, e.id as id from employee e LEFT OUTER JOIN roles r ON e.role_id = r.id' ;
        return await this.mysqlCon.executeQuery(sql);
    }
